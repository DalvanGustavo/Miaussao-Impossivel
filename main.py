...
fases_itens = [
    ...
    {"nome": "Cama","img_idx": 1, "cnt_idx": 1, "meta": 3},  # fase 1: Cama -> contador[1]
    {"nome": "Rato","img_idx": 2, "cnt_idx": 2, "meta": 3},  # fase 2: Rato -> contador[2]
]
...
while running:
    ...
    if estado == 'Menu':
        ...
        try:
            # tenta manter a vel_y do escopo externo ao loop
            vel_y
        except NameError:
            vel_y = 0
        vel_y += gravidade
